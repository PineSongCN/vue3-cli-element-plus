            ...
            <a-space direction="vertical" :size="16">
                    ...
                    <a-row :gutter="80">
                        <a-col :span="8">
                            ...
                            >
                                <a-select
                                    :placeholder="
                                        $t('groupForm.placeholder.video.mode')
                                    "
                                >
                    ...
                    <a-row :gutter="80">
                        <a-col :span="8">
                            <a-form-item
                                :label="
                                    $t(
                                        'groupForm.form.label.video.encoding.resolution'
                                    )
                                "
                        ...
                        <a-col :span="8">
                            <a-form-item
                                :label="
                                    $t(
                                        'groupForm.form.label.video.encoding.rate.min'
                                    )
                                "
                        ...
                        <a-col :span="8">
                            <a-form-item
                                :label="
                                    $t(
                                        'groupForm.form.label.video.encoding.rate.max'
                                    )
                                "
                    ...
                    <a-row :gutter="80">
                        <a-col :span="8">
                            <a-form-item
                                :label="
                                    $t(
                                        'groupForm.form.label.video.encoding.rate.default'
                                    )
                                "
                        ...
                        <a-col :span="8">
                            <a-form-item
                                :label="
                                    $t(
                                        'groupForm.form.label.video.encoding.frameRate'
                                    )
                                "
                        ...
                        <a-col :span="8">
                            <a-form-item
                                :label="
                                    $t(
                                        'groupForm.form.label.video.encoding.profile'
                                    )
                                "
                            ...
                            >
                                <a-input
                                    :placeholder="
                                        $t(
                                            'groupForm.placeholder.video.encoding.profile'
                                        )
                                    "
                                >
                                    <template #append> bps </template>
                    ...
                    <a-row :gutter="80">
                        <a-col :span="8">
                            ...
                            >
                                <a-select
                                    :placeholder="
                                        $t('groupForm.placeholder.audio.mode')
                                    "
                                >
                                    <a-option value="custom">自定义</a-option>
                                    <a-option value="mode1">模式1</a-option>
                        ...
                        <a-col :span="8">
                            <a-form-item
                                :label="
                                    $t(
                                        'groupForm.form.label.audio.acquisition.channels'
                                    )
                                "
                        ...
                        <a-col :span="8">
                            <a-form-item
                                :label="
                                    $t(
                                        'groupForm.form.label.audio.encoding.channels'
                                    )
                                "
                            ...
                            >
                                <a-input
                                    :placeholder="
                                        $t(
                                            'groupForm.placeholder.audio.encoding.channels'
                                        )
                                    "
                                >
                                    <template #append> bps </template>
                    ...
                    <a-row :gutter="80">
                        <a-col :span="8">
                            <a-form-item
                                :label="
                                    $t(
                                        'groupForm.form.label.audio.encoding.rate'
                                    )
                                "
                            ...
                            >
                                <a-input
                                    :placeholder="
                                        $t(
                                            'groupForm.placeholder.audio.encoding.rate'
                                        )
                                    "
                                >
                                    <template #append> bps </template>
                        ...
                        <a-col :span="8">
                            <a-form-item
                                :label="
                                    $t(
                                        'groupForm.form.label.audio.encoding.profile'
                                    )
                                "
                            ...
                            >
                                <a-input
                                    :placeholder="
                                        $t(
                                            'groupForm.placeholder.audio.encoding.profile'
                                        )
                                    "
                                >
                                    <template #append> fps </template>
                ...
                <a-card class="general-card" :bordered="false">
                    ...
                    >
                        <a-textarea
                            :placeholder="
                                $t('groupForm.placeholder.description')
                            "
                        />
                    </a-form-item>
                </a-card>
